...
public class FaceApiService(IOptions<AzureFaceApi> options)
{
    ...
    private readonly string SubscriptionKey = options.Value.Key;
    private readonly string Endpoint = options.Value.Endpoint;


    public async Task Recognize()
    {
        var RecognitionModel4 = FaceRecognitionModel.Recognition04;
     ...
     */
    private static FaceClient Authenticate(string endpoint, string key)
    {
    ...
    private static async Task<List<FaceDetectionResult>> DetectFaceRecognize(FaceClient faceClient, string url, FaceRecognitionModel recognitionModel)
    {
        ...
        var sufficientQualityFaces = new List<FaceDetectionResult>();
...
/*
         ...
         */
        private async Task IdentifyInLargePersonGroup(FaceClient client, string url, FaceRecognitionModel recognitionModel)
        {
